  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-800 text-2xl text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-500/50"
      ...
      {/* 2. THE CHAT WINDOW (Only renders when isOpen is true) */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 flex flex-col h-[560px] w-full max-w-[400px] max-w-[calc(100vw-3rem)] rounded-2xl border border-stone-200 overflow-hidden font-sans shadow-2xl shadow-emerald-900/10 bg-stone-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      {/* Global styles for the bouncing animation */}
      <style>{`
        @keyframes bounce {
